// string de coneção com o banco
// mongodb+srv://victorhfxavier:mongo123@cluster0.hmmghkk.mongodb.net/?retryWrites=true&w=majority
...
async function conectarMongo() {
   await mongoose.connect(`mongodb+srv://victorhfxavier:mongo123@cluster0.hmmghkk.mongodb.net/?retryWrites=true&w=majority`)
}
...
app.post('/filmes', async (req, res) => {
    ...
    //insere o filme novo na lista filmes e agora mudamos para mandar para o Mongo
    await filme.save()
    //só para conferir/ e agora ele vai vai carregar a base atualizada
    const filmes = await Filme.find()
    res.json(filmes)
})
...
app.listen(3000, () => {
    try {
        conectarMongo();
        console.log('conexao ok e up and running')
    }  
    catch (e) {
        console.log('epa: ', e)
    } 
